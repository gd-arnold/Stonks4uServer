...
export class createProcessedStatementsTable1658856762590 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "processed_statements" ADD CONSTRAINT "FK_6c52c1b859988e2c6f763bc6562" FOREIGN KEY ("statementId") REFERENCES "statements"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
	}
