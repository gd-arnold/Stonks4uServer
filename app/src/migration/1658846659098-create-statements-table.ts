...
export class createStatementsTable1658846659098 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "statements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."statements_type_enum" NOT NULL, "amount" numeric(11,2) NOT NULL, "required_process" integer NOT NULL, "date" TIMESTAMP NOT NULL, "automaticPayment" boolean NOT NULL, "recurrenceRule" text NOT NULL, "categoryId" uuid, "recurringTypeId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7f53bcddeb706df7ea7eec10b8d" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
